...
dt = 10e-3
simulation_time = 3
t = np.linspace(0, simulation_time - dt, simulation_time / dt)
...
# figure
plt.figure()
plt.plot(t, th, linestyle='-', color=gray, linewidth=6.0, label='w/o encryption')
plt.plot(t, th_, linestyle='-', color=blue, linewidth=3.0, label='w/ encryption')
plt.plot(t, r_th_, linestyle='--', color=black, linewidth=1.0)
plt.xlabel("Time (s)")
...
plt.savefig("./fig/RPmanipulator_control_theta.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)

plt.figure()
plt.plot(t, d, linestyle='-', color=gray, linewidth=6.0, label='w/o encryption')
plt.plot(t, d_, linestyle='-', color=blue, linewidth=3.0, label='w/ encryption')
plt.plot(t, r_d_, linestyle='--', color=black, linewidth=1.0)
plt.xlabel("Time (s)")
plt.ylabel(r"$d_{2}$")
plt.xlim(0, simulation_time)
plt.ylim(1, 1.6)
...
plt.legend(loc='lower right')
plt.savefig("./fig/RPmanipulator_control_d.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
