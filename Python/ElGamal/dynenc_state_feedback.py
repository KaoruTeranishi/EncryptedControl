...
for k in range(len(t)):
	# state encryption
	for i in range(n):
		x_enc[k][i] = csys.Enc(x_[k,i], gamma_p)
	...
	# input decryption
	for i in range(m):
		u_[k,i] = csys.Dec(u_enc[k][i][0], gamma_c * gamma_p)
		for j in range(1, n):
			u_[k,i] += csys.Dec(u_enc[k][i][j], gamma_c * gamma_p)
	# plant update
...
plt.savefig("./fig/dynenc_input.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.savefig("./fig/dynenc_state.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynenc_enc_input_1.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynenc_enc_input_2.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynenc_enc_state_11.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynenc_enc_state_12.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynenc_enc_state_21.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynenc_enc_state_22.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynenc_pk.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynenc_sk.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
