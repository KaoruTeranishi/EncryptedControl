...
plt.savefig("./fig/dynqtz_input.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.savefig("./fig/dynqtz_state.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynqtz_enc_input_1.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynqtz_enc_input_2.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynqtz_enc_state_11.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynqtz_enc_state_12.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynqtz_enc_state_21.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynqtz_enc_state_22.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/dynqtz_gamma_p.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
