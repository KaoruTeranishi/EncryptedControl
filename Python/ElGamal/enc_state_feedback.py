...
plt.xlim(0, simulation_time)
plt.savefig("./fig/enc_input_1.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/enc_input_2.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/enc_state_11.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/enc_state_12.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/enc_state_21.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
...
plt.xlim(0, simulation_time)
plt.savefig("./fig/enc_state_22.eps", dbi=300, bbox_inches='tight', pad_inches=0.05, transparent=True)
