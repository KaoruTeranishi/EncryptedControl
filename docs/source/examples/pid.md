...
This example illustrates encrypted PI controls using the homomorphic encryption schemes in ECLib.
...
- ElGamal
    ...
    `python pid.py elgamal`

- Dynamic-key ElGamal

    `python pid.py dyn_elgamal`

- Paillier

    `python pid.py paillier`
