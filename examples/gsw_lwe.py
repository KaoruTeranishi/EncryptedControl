...
ct_gsw_x1 = enc_gsw(params, pk, x1, delta)
ct_gsw_v1 = enc_gsw(params, pk, v1, delta)
ct_gsw_m1 = enc_gsw(params, pk, m1, delta)
...
print(f'x1 * x2 = {x1 * x2}')
print(f'enc: {dec(params, sk, mult(params, ct_gsw_x1, ct_x2), delta ** 2)}')
print(f'x1 * v2 = {x1 * v2}')
print(f'enc: {dec(params, sk, mult(params, ct_gsw_x1, ct_v2), delta ** 2)}')
print(f'x1 * m2 = \n{x1 * m2}')
print(f'enc: \n{dec(params, sk, mult(params, ct_gsw_x1, ct_m2), delta ** 2)}')
print(f'v1 * v2 = {v1 @ v2}')
print(f'enc: {dec(params, sk, mult(params, ct_gsw_v1, ct_v2), delta ** 2)}')
print(f'm1 * v2 = {m1 @ v2}')
print(f'enc: {dec(params, sk, mult(params, ct_gsw_m1, ct_v2), delta ** 2)}')
print(f'm1 * m2 = \n{m1 @ m2}')
print(f'enc: \n{dec(params, sk, mult(params, ct_gsw_m1, ct_m2), delta ** 2)}')
print('')

print('elementwise multiplication')
print(f'v1 .* v2 = {v1 * v2}')
print(f'enc: {dec(params, sk, elementwise_mult(params, ct_gsw_v1, ct_v2), delta ** 2)}')
print(f'm1 .* v2 = \n{m1 * v2}')
print(f'enc: \n{dec(params, sk, elementwise_mult(params, ct_gsw_m1, ct_v2), delta ** 2)}')
print(f'm1 .* m2 = \n{m1 * m2}')
print(f'enc: \n{dec(params, sk, elementwise_mult(params, ct_gsw_m1, ct_m2), delta ** 2)}')
print('')
